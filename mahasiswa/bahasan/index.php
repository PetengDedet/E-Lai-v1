			...
			<div class="row">
				...
				<div class="col-md-9 col-xs-12" style="background:#fff;padding:20px;">
					...
					<?php 
						...
						$qtopik = mysql_query("SELECT * FROM view_list_topik WHERE ruang_id='$sesid' ORDER BY topik_update DESC LIMIT $offset,$bph");
						...
						<?php
							...
							<div class="alert alert-success"><span class="glyphicon glyphicon-ok"></span> Belum ada topik untuk dibahas</div>						
						<?php
						}
