				      ...
				      <ul class="nav navbar-nav navbar-right">
					    <li class="dropdown">
					      ...
					      <ul class="dropdown-menu" style="">
					        <li><a href="editadm.php?id=<?php echo $_SESSION['id'];?>"><span class="glyphicon glyphicon-user"></span> - Profil</a></li>
					        <li class="divider"></li>
			...
			<div class="row">
				...
				<div class="col-md-9 col-xs-12" style="background:#fff;padding:20px;">
					...
					<ul class="nav nav-pills nav-justified">
						<li class="active"><a href="#tabeladm" data-toggle="tab">Data Administrator</a></li>
						<li><a href="#inputadm" data-toggle="tab">Input Administrator</a></li>
					</ul>
					<!--TAB CONTENT -->
					<div class="tab-content">
						<div class="tab-pane active" id="tabeladm"><br>
							<table class="table table-hover table-striped table-responsive">
								...
								<tbody>
									<?php
										...
										$qmhs = "SELECT * FROM administrator ORDER BY administrator_id DESC LIMIT $offset,$bph";
									...
									?>
											<tr>
												<td><?php echo $no;?></td>
												<td><?php echo $smhs['administrator_id'];?></td>
												<td><?php echo $smhs['administrator_nama'];?></td>
												<td><a class="btn btn-danger btn-xs" href="deladm.php?id=<?php echo $smhs['administrator_id'];?>"><span class="glyphicon glyphicon-trash"></span></a> <a class="btn btn-warning btn-xs" href="editadm.php?id=<?php echo $smhs['administrator_id'];?>"><span class="glyphicon glyphicon-edit"></span></a></td>
											</tr>
									<?php
											$no++;
											}
							...
							<?php 
								...
								$qdt 	= "SELECT COUNT(*) AS hdt FROM administrator";
					...
					<!-- FORM -->
						<div class="tab-pane" id="inputadm"><br>
							...
							<?php 
								if (isset($_POST['simpan'])) {
									...
									$nmgmbr 	 = anti_injection(md5(md5(md5($nama.$password))));
									#jika terisi
									if (empty($nama)) {
									...
									elseif (!empty($_FILES['gambar']['tmp_name'])){								
										...
										$targetfile 	= "../../img/adm/".$nama.$nmgmbr.".jpg";
										move_uploaded_file($lokasigambar,$targetfile);
										mysql_query("INSERT INTO administrator (administrator_id,administrator_nama,administrator_password,administrator_gambar) VALUES ('','$nama','$password','$targetfile')");
										echo "<meta http-equiv=refresh content=0;URL=index.php>";
									}
									else{
										mysql_query("INSERT INTO administrator (administrator_id,administrator_nama,administrator_password) VALUES ('','$nama','$password')");
										echo "<meta http-equiv=refresh content=0;URL=index.php>";	
									}
								}
							?>
