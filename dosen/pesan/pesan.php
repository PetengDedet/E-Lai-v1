		...
		<div class="container" style="">
			<div class="row">
				...
				<div class="col-md-9 col-xs-12" style="background:#fff;padding:20px;">
					...
					<?php 
						$pesanid = $_GET['id'];
						$ambilpesan = mysql_query("SELECT pesan.*,mahasiswa.mahasiswa_nama FROM pesan LEFT JOIN mahasiswa ON pesan.mahasiswa_npm=mahasiswa.mahasiswa_npm WHERE pesan_id=$pesanid");
						if (mysql_num_rows($ambilpesan)>0) {
								 	...
								 	<div class="col-sm-6">	
								 		<table class="table">
								 			<tr>
								 				...
								 				<td><?php echo $hpesan['mahasiswa_nama']; ?></td>
								 			</tr>
								 			<tr>
							...
							<?php 
								if (isset($_POST['kirim'])) {
									...
									mysql_query("INSERT INTO pesan(pesan_id,pesan_subjek,pesan_isi,pesan_lampiran,mahasiswa_npm,dosen_kode)VALUES('','$subj','$isi','','$hpesan[MAHASISWA_NPM]','$dsn')");
