			...
			<div class="row">
				...
				<div class="col-md-9 col-xs-12" style="background:#fff;padding:20px;">
					...
					<ol class="breadcrumb">
					  ...
					  <li class="active">Bahasan</li>
					</ol>
					<a href="topikbaru.php" class="btn btn-primary" ><span class="glyphicon glyphicon-pencil"></span> Buat Topik Baru</a>
					<br />
					<br />
					<div class="list-group">
					<?php 
						...
						$offset = ($halke-1)*$bph;
						$sesid = $_SESSION['id'];
						$qtopik = mysql_query("SELECT * FROM view_list_topik WHERE dosen_kode='$sesid' ORDER BY topik_update DESC LIMIT $offset,$bph");
						$jtopik = mysql_num_rows($qtopik);
						if ($jtopik>0) {
							$no = 1;
							while ($htopik = mysql_fetch_array($qtopik)) {
									if (($htopik['TAHUNAKADEMIK_STATUS']=='Aktif')&&($htopik['SEMESTER_STATUS']=='Aktif')) {
										
						?>
								<a class="list-group-item" style="border-left:5px #36c solid;" href="topik.php?t=<?php echo $htopik['topik_id']; ?>">
									<h4><?php  $tj = $htopik['topik_judul']; echo htmlspecialchars_decode($tj); ?><small> <?php echo $htopik['matakuliah_string']; ?> | <?php echo $htopik['KONSENTRASI_STRING'];?></small></h4>
									<p>
									   <?php echo "Ruang : ".$htopik['ruang_string']." ".$htopik['KAMPUS_STRING'];?>
									</p>
									<p><?php $sumisi = $htopik['topik_isi']; echo substr($sumisi,0,100); ?></p>
								</a>
						<?php
							}
							elseif (($htopik['TAHUNAKADEMIK_STATUS']=='Aktif')&&($htopik['SEMESTER_STATUS']=='Tidak Aktif')) { ?>
						
								<a class="list-group-item" style="border-left:5px #fc0 solid;" href="topik.php?t=<?php echo $htopik['topik_id']; ?>">
									<h4><?php  $tj = $htopik['topik_judul']; echo htmlspecialchars_decode($tj); ?><small> <?php echo $htopik['matakuliah_string']; ?> | <?php echo $htopik['KONSENTRASI_STRING'];?></small></h4>
									<p>
									   <?php echo "Ruang : ".$htopik['ruang_string']." ".$htopik['KAMPUS_STRING'];?>
									</p>
						...
						<?php		
								...
								<a class="list-group-item" style="border-left:5px #000 solid;" href="topik.php?t=<?php echo $htopik['topik_id']; ?>">
									<h4><?php  $tj = $htopik['topik_judul']; echo htmlspecialchars_decode($tj); ?><small> <?php echo $htopik['matakuliah_string']; ?> | <?php echo $htopik['KONSENTRASI_STRING'];?></small></h4>
									<p>
									   <?php echo "Ruang : ".$htopik['ruang_string']." ".$htopik['KAMPUS_STRING'];?>
									</p>
						...
						$hitungtopik = mysql_query("SELECT COUNT(*) AS jtotaltopik FROM view_list_topik WHERE dosen_kode='$_SESSION[id]'");
