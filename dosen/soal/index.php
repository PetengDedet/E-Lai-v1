		...
		<div class="container" style="">
			<div class="row">
				...
				<div class="col-md-9 col-xs-12" style="background:#fff;padding:20px;">
					...
					<a href="soalbaru.php" class="btn btn-primary" ><span class="glyphicon glyphicon-pencil"></span> Buat Soal Baru</a>
					<br />
					<br />
					<div class="list-group">
					<?php 
						...
						$offset = ($halke-1)*$bph;
						$sesid = $_SESSION['id'];
						$qtopik = mysql_query("SELECT * FROM view_soal WHERE dosen_kode='$sesid' ORDER BY soal_id DESC LIMIT $offset,$bph");
