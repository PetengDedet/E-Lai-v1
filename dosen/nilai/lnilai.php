...
<html>
	...
	<body style="text-shadow: 0px 0px 1px #909090 !important;background:#eee;">
<!--DOSEN-->	
		<div class="container" style="">
			...
			<div class="col-md-10" style="background:#fff;padding-top:20px;">
				...
				<div class="panel panel-default" style="border:none;">
					<div class="panel-body">
						...
						<?php
							$carinilai = mysql_query("SELECT * FROM view_nilai WHERE soal_id='$sid'");
			...
			<div class="col-md-1" style="padding-left:0px;">
				<div class="btn-group-vertical" style="position:relative;">
					<a href="index.php" class="btn btn-warning btn-sm"><span class="glyphicon glyphicon-remove-circle"></span></a>
					<?php 
						if ($j>0) {?>
						<a href="pnilai.php?id=<?php echo $artopik['soal_id']; ?>" class="btn btn-primary btn-sm"><span class="glyphicon glyphicon-print"></span></a>	
					<?php
						}
					?>					
				</div>
